...
class MannschaftProtokoll
{
    ...
    /**
     * Fügt eine Verknüpfung zwischen MannschaftModel und ProtocolModel hinzu.
     *
     ...
     *                     - mannschaft_ID: ID der MannschaftModel.
     *                     - protokoll_Nr: Nummer des Protokolls.
     *                     - erreichte_Punkte: Erreichte Punkte der MannschaftModel im ProtocolModel (int).
