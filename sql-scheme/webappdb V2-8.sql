...
--
-- Host: db
-- Generation Time: Apr 09, 2025 at 10:07 AM
...
CREATE TABLE `User` (
  ...
  `station_Nr` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `Station`
  MODIFY `Nr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- Constraints for table `ProtokollProtokoll`
--
ALTER TABLE `Protokoll`
  ADD CONSTRAINT `Protokoll_ibfk_1` FOREIGN KEY (`station_Nr`) REFERENCES `Station` (`Nr`);
...
ALTER TABLE `User`
  ...
  ADD CONSTRAINT `User_ibfk_2` FOREIGN KEY (`station_Nr`) REFERENCES `Station` (`Nr`);
COMMIT;
