...
CREATE TABLE `Question` (
  `ID` int(11) NOT NULL,
  `QuestionFormular_ID` int(11) NOT NULL,
  `Text` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `Question`
  ...
  ADD KEY `fk_question_questionformular` (`QuestionFormular_ID`);
...
--
ALTER TABLE `Question`
  ADD CONSTRAINT `fk_question_questionformular` FOREIGN KEY (`QuestionFormular_ID`) REFERENCES `QuestionForm` (`ID`);
